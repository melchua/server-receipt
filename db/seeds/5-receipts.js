  ...
  return knex('receipts').del()
    .then(function () {
      ...
      return knex('receipts').insert([
        ...
        {id: 4, location: "Tim Hortons", total: 10000, date: "4/12/18", user_id: 2, project_id: 1, description:"double double all day",
        image_url: "http://www.catster.com/wp-content/uploads/2017/08/A-fluffy-cat-looking-funny-surprised-or-concerned.jpg",
        category_id: 1, status_id: 3},
        {id: 3, location: "Lighthouse", total: 1000000, date: "4/8/18", user_id: 2, project_id: 1, description:"learning how to code is very expensive",
        image_url: "http://www.catster.com/wp-content/uploads/2017/08/A-fluffy-cat-looking-funny-surprised-or-concerned.jpg",
